...
public class SimpleChatPrivateMessaging
{
	...
	public static void msg(Player p, String otherP, String msg)
	{
		...
		{
			p.sendMessage("§a[SimpleChat] §4The name §c" + otherP + " §4matched more than one player. Please enter a different/more-specific name.");
			return;
		}
		...
		String[] replace = { p.getName(), p.getDisplayName(), SimpleChatAPI.getPrefix(p), SimpleChatAPI.getSuffix(p), SimpleChatAPI.getGroup(p), matchedPlayer.getName(), matchedPlayer.getDisplayName(), SimpleChatAPI.getPrefix(matchedPlayer), SimpleChatAPI.getSuffix(matchedPlayer), SimpleChatAPI.getGroup(matchedPlayer), msg, "§" };

		String[] replace2 = { matchedPlayer.getName(), matchedPlayer.getDisplayName(), SimpleChatAPI.getPrefix(matchedPlayer), SimpleChatAPI.getSuffix(matchedPlayer), SimpleChatAPI.getGroup(matchedPlayer), p.getName(), p.getDisplayName(), SimpleChatAPI.getPrefix(p), SimpleChatAPI.getSuffix(p), SimpleChatAPI.getGroup(p), msg, "§" };
		...
		{
			if (onlinePlayer == p || onlinePlayer == matchedPlayer)
			{
				continue;
			}
			...
			{
				onlinePlayer.sendMessage("§8§l[§r§7" + p.getName() + " §e-> §7" + matchedPlayer.getName() + "§8§l] §r§6§o" + msg);
			}
		}
	...
	public static void lockPM(Player p, String otherP)
	{
		...
		p.sendMessage("§a[SimpleChat] §2PM Locked. All chat from you now goes to §c" + matchedPlayer.getName());
